""" 
This code is the source code fro the python library flirimageextractor.
Github repo: https://github.com/nationaldronesau/FlirImageExtractor

There exists little documentaion about this library online. In order to figure out how to use the library you can either read through this code, or read usage.py.
"""
